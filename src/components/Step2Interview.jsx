...
function Step2Interview({interviewData , onFinish}) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
        <div className='w-full max-w-350 min-h-[80vh] bg-wite rounded-3xl shadow-2xl order border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
            ...
            {/* video section */}
              <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
                   ...
                   {/* subtittle */}
                     {subtitle && (
                      <div className='w-full max-w-md bg-gray-50 border border-gray-200 rounded-xl p-4 shadow-sm'>
                        <p className='text-gary-700 text-sm sm:text-base font-medium text-center leading-relaxed'>{subtitle}</p>
                      </div>
                     )}
               ...
               {/* text section */}
                <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relatives'>
