    ...
    const navigate = useNavigate()
      ...
      if(finalScore >= 8) {
         ...
         shortTagline = "Good foundation, refine articulation.";
          ...
          shortTagline = "Wok on clarity and confidence."; 
      }
      ...
      let currentY = 25;
        ...
        doc.text(`Communcitation: ${communication}`, margin + 10, currentY + 18);
        ...
        if (finalScore >= 8) {
          advice = 
          "Excellnet performance. Maintain confidence and structure. Continue refining clarity and supporting answers with strong real-world examples.";
        } else if (finalScore >= 5) {
          advice =
          ...
          advice = 
            "Significant improvement required. Focus on structured thinking, clarity, and confident delivery. Practice anwering aloud regularly."
        }
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
          ...
          <div className='space-y-6'>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="bg-white rounded-2xl sm:rounded-3xl sm:rounded-3xl shadow-lg p-6 sm:p-8 text-center">
          ...
          <div className='lg:col-span-2 space-y-6'>
           ...
           <motion.div
             initial={{ opacity: 0 }}
             animate={{ opacity: 1 }}
             className='bg-white rouded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className='bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 asm:p-8'>
